        ...
        {allStepsCompleted() ? (
          ...
          <React.Fragment>
            <Typography sx={{ mt: 2, mb: 1, py: 1 }}>
              {
                activeStep == 0 ?
                  <FormControl sx={{ backgroundColor: '#1D1F23', height: '', marginTop: '2rem', marginBottom: '3rem', display: 'flex', flexDirection: 'column', rowGap: '8vh', borderRadius: '20px', padding: '3rem' }}>
                    <Box sx={{ display: 'flex', columnGap: '2rem' }}>
                      <Box sx={{ flex: 2 }}>
                        <TextField fullWidth id="outlined-basic" label="Token Address" variant="outlined"
                          sx={{ mt: '0.2rem', mb: '1rem' }} InputProps={{
                            endAdornment: (
                        ...
                        <FormControl fullWidth sx={{ mt: 1 }} variant="standard">
                          ...
                          <Box sx={{ flex: '1', justifyContent: 'space-between', borderBottom: '1px solid rgba(255, 255, 255, 0.1)', py: '1.4%' }} display="flex" justifyContent="center" alignItems="center" >
                            ...
                            <Typography component="p" sx={{ fontWeight: '400', fontSize: '12px', color: '#FFFFFF' }}>BXYZ</Typography>
                          </Box>
                          <Box sx={{ flex: '1', justifyContent: 'space-between', borderBottom: '1px solid rgba(255, 255, 255, 0.1)', py: '1.4%' }} display="flex" justifyContent="center" alignItems="center" >
                    ...
                    <Box sx={{
                      ...
                      <ColorButton sx={{ fontWeight: '700', float: 'left', width: '8rem' }}>Approve</ColorButton>
                      <Typography component="p" sx={{
                        float: 'left', width: '70%', textAlign: 'left', mt: '6px',
                        color: '#FC9823'
                      }}>Make sure token has “Exclude transfer fee” and “Exclude Max Transaction” if you use tax/Fees or Max Transaction limits.</Typography>
                    </Box>
                  </FormControl>
                  :
                  activeStep == 1 ?
